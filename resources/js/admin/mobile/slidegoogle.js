...
// Le estoy diciendo al script que va a haber animaciones
...
//1-Declaro variables que seran las acciones pointerdown/pointerup/pointermove
var pointerDownName = 'pointerdown'; //pointerdown-->Se activa cuando dejamos de clicar con el dedo
var pointerUpName = 'pointerup'; //pointerup-->se activa cuando clicamos con el dedo
var pointerMoveName = 'pointermove'; //pointermove-->Se activa mientras movemos el dedo*/
//

/*Esta parta es para que funcione en explorer asi que lo quitamos
...
/*2- Esto sirve para ver si el sistema coge los nombres de las variables de antes (pointerDownName, etc). 
En si no hace nada asi que este apartado se podia quitar
    ...
    /**/console.log(window.PointerEventsSupport) //Este Console.log se lo doy yo para ver que la variable funciona
/**/
