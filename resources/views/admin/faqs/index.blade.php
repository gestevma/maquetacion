    ...
    <form class="admin-form" id="faqs-form" action="{{route("faqs_store")}}" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <div class="form-input">
                <input type="text" class="input" name="Pregunta  1" id="Pregunta1">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="form-input">
                <textarea placeholder="Escriba algo" type="text" class="input" name="Respuesta 1" id="Respuesta1"></textarea>
            </div>
        </div>
