@extends('admin.desktop.layout.table_form')
    ...
    <form class="admin-form" id="faqs-form" action="{{route("faqs_store")}}" autocomplete="off">
        ...
        <div class="form-group">
            ...
            <div class="form-input" id="answer">
                <textarea type="text" class="input"  name="description" id="Respuesta1" placeholder="Escriba algo">{{isset($faq->description) ? $faq->description : ''}}</textarea>
            </div>
        </div>
