    ...
    <div class="shop">
        ...
        <div class = "discount-price">
            @if($book->products['discount'] > 0)
                ...
                <p class = "discount">{{isset($book->products['discount']) ? "(".floatval($book->products['discount'])."% de descuento)" : ""}}</p>
            @endif
        </div>
        ...
        <div class="shop-bottons">    
            <div class="shop-cart shop-button">
                ...
                <p class="add-to-cart shop-text">Añadir al carrito<p>
            </div>
            ...
            <div class="shop-buy shop-button">
                ...
                <p class="buy-it shop-text">Comprar ya<p>
            </div>
