...
@section('content')
    ...
    <div class = "contact">
        ...
        <div class = "ourinformation">
            ...
            <div class = "map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4310.65488484743!2d-4.461134737911928!3d40.1847370375192!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd4035b57551b6f3%3A0x84be095154d712f6!2sCalle%20Falsa%2C%2045908%20Aldea%20en%20Cabo%2C%20Toledo!5e0!3m2!1ses!2ses!4v1623151079136!5m2!1ses!2ses" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>

        </div>

        <form class="contact-form" action="{{route("contact_store")}}" autocomplete="off">
            ...
            <div class="form-group">
                <div class="form-label">
                    <label><p class="form-label-title">Teléfono:</p></label>
                </div>
                <div class="form-input" id="question">
            ...
            <div class="form-group">
                ...
                <div class="form-input" id="question">
                    <textarea class="input ckeditor" > </textarea>
                </div>
            </div>
